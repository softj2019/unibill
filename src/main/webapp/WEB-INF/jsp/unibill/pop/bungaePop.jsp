...
<script type="text/javascript">
	...
	function bungae_insert(){
		var billym = $("#frm_bungae").find("#in_billym option:selected").val();
		var jurdat = $("#frm_bungae").find("#in_jurdat").val();
		...
		CUSTOM.fn_genProc('prc_bungae','','frm_bungae','#in_billym','#in_jurdat', '#in_user_id');
	}
</script>

<%-- bungae 상세정보 --%>
<form id="frm_bungae" name="frm_bungae" method="post">
<input type="hidden" id="tableName" name="tableName" value="mb_bungae" /> 
<input type="hidden" id="callBackFunction" name="callBackFunction" value="" />
<input type="hidden" id="qtype" name="qtype" value="" />
<input type="hidden" id="qseq" name="qseq" value="" />
<input type="hidden" id="in_user_id" name="in_user_id" value="${userId}" />
<div class="confirm_cont" style="width:350px;height:200px;"><!-- 팝업창 크기에 맞게 위치변경 -->
        ...
        <table summary="추가정보(선택)" class="tb02" style="padding:0px;">
            ...
            <tbody> 
                <tr>
                    ...
                    <td class="paddingTd" >
						<div>
							<select id="in_billym" name="in_billym" style="width:${sWidth}px;" class="input ${sObjNm}" >
                ...
                <tr>
                    ...
                    <td class="paddingTd" >
						<input type="text" id="in_jurdat" name="in_jurdat" class="datepicker input ES ON_전표기표일" maxlength="10" style="width:110px"/>
					</td>
                </tr>
            </tbody>
        </table>
        ...
        <div class="btn_pop_wrap">
        	<button type="button" onclick="bungae_insert()" class="btn_pop">확인</button>
        	<button type="button" class="btn_pop" onclick="document.getElementById('bungae_pop').style.display = 'none'">닫기</button>
        </div>
    </div>
</form>